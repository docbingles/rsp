    ...
    def fsm_loop(self):
        while not rospy.is_shutdown():
            if self.state == RobotState.IDLE:
                ...
                rospy.loginfo_throttle(2, f"Navigating to pickup... Distance travelled: {self.distance_travelled:.2f}m")
                self.move_forward()
                ...
                rospy.loginfo_throttle(2, f"Navigating to delivery... Distance travelled: {self.distance_travelled:.2f}m")
                self.move_forward()
                self.distance_travelled += self.linear_speed * 0.1
